...
<img src="https://github.com/quang-phong/project-1-beat-2022-european-crises/blob/main/media/gif/dog-says-hi.gif" width="80px">
</h1>

<img align='right' src="https://github.com/quang-phong/project-1-beat-2022-european-crises/blob/main/media/gif/winter-heat-white.gif" width="400px">
...
## 🧐 What?
"Beat 2022 European Crises" is a short name for the project titled "**Detect and estimate occupancy via IoT-enabled air quality sensor with machine learning** – a potential privacy-preserving approach to deal with looming Covid-19 waves and winter gas shortage".

## 🤷 Why?  
Given the energy crisis facing European countries in the heat of summer 2022, and the looming Covid-19 waves in winter, occupancy monitoring based on non-intrusive approaches has potentials to help schools and public building owners deal with all regulatory changes. This is a new application that has not been deployed in practice.
